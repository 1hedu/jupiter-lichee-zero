...
/* Jupiter port: bump from 8 → 2. Upstream's /8 divisor underestimates the
 * needed frontier on fully-passable terrain — we saw 100-slot overflow on a
 * trivial 40×20 self-test at distance 37. /2 gives 400 slots for the same
 * map, handling real-sized searches at modest BSS cost. */
#define MAX_OPEN_SET_RATIO 2
