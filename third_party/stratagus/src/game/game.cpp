...
/* Jupiter port: was `static`. Bridge's ExitFatal-longjmp recovery resets
 * it so a second StartMap doesn't see a leftover `true`. */
bool LcmPreventRecurse;   /// prevent recursion through LoadGameMap
