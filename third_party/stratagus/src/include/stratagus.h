...
#include <string>
#include <vector>
#include <cstdarg>  /* port: player.cpp uses va_list but upstream relied on transitive include */
#include <cstdio>   /* port: fprintf/stderr/stdout used in logging macros */
